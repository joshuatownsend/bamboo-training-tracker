...
-- Update the trigger_bamboohr_sync function to use the http_post function with proper named parameters
...
BEGIN
  ...
  -- Fix: Use named parameters format which is required in newer versions of pg_net extension
